...
import (
	...
	"golang.zx2c4.com/wireguard/apple/pkg/deviceClone"
...
func main() {
	device.DiscardLogf("123", "123")
	deviceClone.DiscardLogf("123", "123")
	fmt.Println("runsource")
	// deviceClone.KDF3(&device.InitialChainKey, &device.InitialChainKey, &device.InitialChainKey, debug.Stack())
}
